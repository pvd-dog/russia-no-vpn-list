...
В этом репозитории мы собрали готовый файл со списком таких адресов, адаптированный для [Amnezia VPN](https://amnezia.org/premium?arf=3GDUZYVJGVCXWP1D). Пользуйтесь и распространяйте!  
...
1. Скачайте из нашего репозитория файл russia-no-vpn-list_by_@pvd_dog.json на своё устройство.   
...
> [!IMPORTANT]
> Мы стремимся дополнять данный список IP-адресов, поэтому если какой-то российский сервис или сайт у вас не открывается с включённым VPN и раздельный туннелированием — сообщите нам в комментариях к данному посту в Телеграме — мы обязательно внесём его IP-адреса в файл.  
